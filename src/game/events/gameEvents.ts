...
export interface ProductRejectedForPriceEvent {
  day: number
  productKey: string
...
export interface EmployeeTaskCompletedEvent {
  day: number
  employeeId: string
  roleKey: string
  taskType: string
...
export interface CheckoutBreakdownEvent {
  day: number
  checkoutId: string
  repairedByEmployeeId?: string
  durationMs: number
}
