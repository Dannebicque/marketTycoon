import type { DemandProduct } from './product'
...
export class MarketDemandManager {
  ...
  evaluatePurchase(product: DemandProduct, salePrice: number, requestedQuantity: number, customer: CustomerPriceContext): PurchaseDecisionResult {
