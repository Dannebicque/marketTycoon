...
<script lang="ts">export type ManagementTab = 'dashboard' | 'finances' | 'needs' | 'reserve' | 'customers' | 'pricing' | 'marketing' | 'employees' | 'orders' | 'settings'</script>
...
const tabs = computed<Array<{key:ManagementTab;label:string}>>(() => { void locale.value; return [
  {key:'dashboard',label:t('management.tabs.dashboard')},{key:'finances',label:t('management.tabs.finances')},{key:'needs',label:'Besoins'},{key:'reserve',label:t('management.tabs.reserve')},{key:'customers',label:t('management.tabs.customers')},{key:'pricing',label:t('management.tabs.pricing')},{key:'marketing',label:'Marketing'},{key:'employees',label:t('management.tabs.employees')},{key:'orders',label:t('management.tabs.orders')},{key:'settings',label:t('management.tabs.settings')},
] })
