  ...
  <div class="management-content direction-panel">
    <section class="direction-hero">
      <div>
        ...
        <p>Le moteur combine calendrier, météo, concurrence, réputation, publicité, promotions et mémoire client pour piloter la journée.</p>
      </div>
    ...
    <section class="direction-grid">
      ...
      <article class="direction-card">
        ...
        <p class="panel-help">La concurrence modifie cette répartition : un discounter attire les profils prix, tandis qu’un commerce de proximité renforce la recherche de praticité.</p>
      </article>
    </section>
